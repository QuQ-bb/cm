	...
	<article class="container">
		...
		<div class="col-sm-6 col-md-offset-3">
			<form action="/join_ok" method="post" role="form"
				...
				<div class="form-group">
					<label for="mem_pass2">비밀번호 확인</label> 
					<input type="password" class="form-control" id="mem_pass2" name="mem_pass2" placeholder="Confirm Password">
				...
				<div class="form-group">
					<label for="mem_email">이메일 주소 (Ex.cmarket@naver.com)</label>
				...
				<div class="form-group">
					<input class="form-control" placeholder="상세주소"
						name="deladd_add2" id="deladd_add2" type="text" />
				</div>
